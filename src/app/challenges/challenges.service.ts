...
export class ChallengeService {
  ...
  fetchCurrentChallenge() {
    return this.http.get<{
      ...
      month: number,
      _days: Day[]
    }>('https://nativescript-angular-6b9db-default-rtdb.firebaseio.com/challenge.json').pipe(tap(resData => {
      if(resData){
  ...
  private saveToServer(challenge: Challenge) {
    this.http.put('https://nativescript-angular-6b9db-default-rtdb.firebaseio.com/challenge.json', challenge).
      subscribe(res => {
        console.log(res)
      });
  }
